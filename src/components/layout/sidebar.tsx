...
// O contador de respostas de e-mail NÃO fica aqui: um número no ícone global
// não diz de qual lead é, e a lista de Conversas já mostra o badge no card de
// cada um — que é onde a informação leva a alguma ação.
const navigation = [
