                    ...
                    <div className="flex-1 flex overflow-hidden">
                        ...
                        <div className="w-[55%] border-r border-border/30 overflow-y-auto p-6 space-y-5">
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-xs font-semibold text-[#37352F] dark:text-[#cbd5e1] uppercase tracking-wide flex items-center gap-1.5">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    <Label className="text-xs font-semibold text-[#37352F] dark:text-[#cbd5e1] uppercase tracking-wide">
                                        ✉️ Email
                                    </Label>
                                    <Input
                                        value={form.email}
                            ...
                            <button
                                onClick={handleSave}
                                disabled={isPending}
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-brand-500 text-[#191918] dark:text-white font-medium text-sm hover:bg-brand-600 disabled:opacity-50 transition-colors shadow-md shadow-brand-500/20"
                            >
                                {isPending ? (
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    ...
                                    {newTaskText.trim() && (
                                        <button
                                            ...
                                            className="p-2 rounded-xl bg-brand-500 text-[#191918] dark:text-white hover:bg-brand-600 transition-colors shrink-0"
                                        >
                            ...
                            <div className="px-4 py-3 border-t border-border/30 shrink-0">
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center w-10 h-10 rounded-xl bg-brand-500 text-[#191918] dark:text-white hover:bg-brand-600 disabled:opacity-50 transition-colors shadow-sm shrink-0"
                                    >
                                        {isPending ? (
                                            <Loader2 className="w-4 h-4 animate-spin" />
                                        ) : (
