        ...
        >
            <div className="flex h-[calc(100vh-180px)]">
                <div className="flex gap-4 overflow-x-auto pb-4 flex-1">
                    ...
                    {/* Inline Add Column */}
                    {addingColumn ? (
                        <div className="flex flex-col w-[300px] min-w-[300px] rounded-2xl bg-[#EEF2FF] dark:bg-[#1e2536]/50 border-2 border-dashed border-brand-500/50 p-4 shrink-0">
                            <input
                                ref={newColRef}
                                value={newColName}
                                ...
                                className="bg-[#F7F7F5] dark:bg-[#0f1829] border border-[#A5B4FC] dark:border-[#4a5568] rounded-xl px-3 py-2 text-sm text-[#191918] dark:text-white placeholder:text-[#6366F1] dark:text-[#94a3b8] outline-none focus:ring-2 focus:ring-brand-400 mb-3"
                            />
                            <div className="flex gap-2">
                                <button
                                    onClick={handleAddColumn}
                                    className="flex-1 px-3 py-2 rounded-xl bg-brand-500 text-[#191918] dark:text-white text-sm font-medium hover:bg-brand-600 transition-colors"
                                >
                                    Criar
                                </button>
                                <button
                                    onClick={() => { setAddingColumn(false); setNewColName(""); }}
                                    className="px-3 py-2 rounded-xl bg-[#E0E7FF] dark:bg-[#2d3347] text-[#37352F] dark:text-[#cbd5e1] text-sm font-medium hover:bg-[#C7D2FE] dark:hover:bg-[#3d4a60] transition-colors"
                                >
                                    Cancelar
                                </button>
                            </div>
                        ...
                        <button
                            ...
                            className="flex flex-col items-center justify-center gap-2 w-[300px] min-w-[300px] min-h-[120px] rounded-2xl border-2 border-dashed border-[#C7D2FE] dark:border-[#3d4a60] hover:border-brand-500/50 hover:bg-brand-500/5 text-[#6366F1] dark:text-[#94a3b8] hover:text-brand-400 transition-all shrink-0 cursor-pointer"
                        >
            ...
            <DragOverlay dropAnimation={null}>
                ...
                {activeColumnId ? (
                    <div className="w-[300px] h-16 rounded-2xl bg-[#E0E7FF] dark:bg-[#2d3347]/80 border-2 border-brand-400 flex items-center justify-center text-sm font-semibold text-brand-400 shadow-xl">
