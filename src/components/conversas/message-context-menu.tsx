            ...
            {open && menuPos && createPortal(
                ...
                >
                    {canal !== "festas" && <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-violet-500/15 text-[#37352F] dark:text-[#cbd5e1] hover:text-violet-200 transition-colors text-sm group/item"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-sky-500/15 text-[#37352F] dark:text-[#cbd5e1] hover:text-sky-200 transition-colors text-sm group/item"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-[#E0E7FF] dark:hover:bg-[#2d3347]/60 text-[#37352F] dark:text-[#cbd5e1] hover:text-[#191918] dark:hover:text-white transition-colors text-sm group/item"
                    >
                        <Copy className="h-3.5 w-3.5 text-[#6366F1] dark:text-[#94a3b8] group-hover/item:scale-110 transition-transform" />
                        Copiar
                    </button>
                    <button
                        type="button"
                        onClick={() => { setOpen(false); onPin(message, !message.pinned); }}
                        className="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-amber-500/15 text-[#37352F] dark:text-[#cbd5e1] hover:text-amber-200 transition-colors text-sm group/item"
                    >
                        {message.pinned
