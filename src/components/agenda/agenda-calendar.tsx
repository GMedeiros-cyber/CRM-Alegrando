        ...
        <>
            ...
            <div className="flex items-center justify-end mb-3">
                <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#E0E7FF] dark:bg-[#2d3347] text-[#37352F] dark:text-[#cbd5e1] text-sm hover:bg-[#C7D2FE] dark:hover:bg-[#3d4a60] transition-colors disabled:opacity-40"
                >
            ...
            <div className="agenda-dark-calendar relative">
                {loadingEvents && (
                    <div className="absolute inset-0 z-10 flex items-center justify-center bg-[#F7F7F5] dark:bg-[#0f1829]/60 rounded-2xl backdrop-blur-sm">
                        <div className="flex items-center gap-3 text-[#37352F] dark:text-[#cbd5e1]">
            ...
            <Dialog open={modalOpen} onOpenChange={setModalOpen}>
                <DialogContent
                    className={
                        modalMode === "view"
                            ? "bg-[#EEF2FF] dark:bg-[#1e2536] border-2 border-[#C7D2FE] dark:border-[#3d4a60] text-[#191918] dark:text-white max-w-md max-h-[90vh] overflow-y-auto"
                            : "bg-[#EEF2FF] dark:bg-[#1e2536] border-2 border-[#C7D2FE] dark:border-[#3d4a60] text-[#191918] dark:text-white max-w-md"
                    }
                >
                    {modalMode === "create" ? (
                        <>
                            <DialogHeader>
                                <DialogTitle className="font-display text-lg text-[#191918] dark:text-white flex items-center gap-2">
                                    <CalendarDays className="w-5 h-5 text-brand-400" />
                                    Novo Agendamento
                                </DialogTitle>
                                <DialogDescription className="text-[#6366F1] dark:text-[#94a3b8]">
                            ...
                            <div className="space-y-4 mt-4">
                                ...
                                <div className="space-y-1.5">
                                    <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">
                                        Título do Evento
                                    </Label>
                                    <Input
                                        value={form.titulo}
                                        ...
                                        className="bg-[#F7F7F5] dark:bg-[#0f1829] border-[#A5B4FC] dark:border-[#4a5568] text-[#191918] dark:text-white placeholder:text-[#6366F1] dark:text-[#94a3b8] rounded-xl"
                                    />
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                        className="w-full rounded-xl bg-[#F7F7F5] dark:bg-[#0f1829] border border-[#A5B4FC] dark:border-[#4a5568] text-[#191918] dark:text-white placeholder:text-[#6366F1] dark:text-[#94a3b8] px-3 py-2 text-sm resize-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500/20 outline-none"
                                    />
                                </div>
                                ...
                                {/* Cliente select */}
                                <div className="space-y-1.5">
                                    <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider flex items-center gap-1">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-brand-500 text-[#191918] dark:text-white font-medium text-sm hover:bg-brand-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-lg shadow-brand-500/25 mt-2"
                                >
                                    {isPending ? (
                        ...
                        <>
                            <DialogHeader>
                                <DialogTitle className="font-display text-lg text-[#191918] dark:text-white">
                                    {selectedEvent.title}
                                </DialogTitle>
                                <DialogDescription className="text-[#6366F1] dark:text-[#94a3b8]">
                            ...
                            <div className="space-y-4 mt-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {selectedEvent.extendedProps.leadId ? (
                                        <div className="bg-[#F7F7F5] dark:bg-[#0f1829]/60 rounded-xl p-3 border border-brand-500/30">
                                        ...
                                        <InfoCard
                                            icon={<School className="w-4 h-4 text-[#6366F1] dark:text-[#94a3b8]" />}
                                            label="Título"
                                    ...
                                    {selectedEvent.extendedProps.description && (
                                        <div className="col-span-2 bg-[#F7F7F5] dark:bg-[#0f1829]/60 rounded-xl p-3 border border-[#C7D2FE] dark:border-[#3d4a60]/50">
                                            <div className="flex items-center gap-1.5 mb-1">
                                                <FileText className="w-4 h-4 text-[#6366F1] dark:text-[#94a3b8]" />
                                                <span className="text-[10px] font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">
                                                    Descrição
                                                </span>
                                            </div>
                                            <p className="text-sm text-[#37352F] dark:text-[#cbd5e1] whitespace-pre-line">
                                                {selectedEvent.extendedProps.description}
                                            </p>
                                        </div>
                                    )}
                                ...
                                <div className="space-y-3">
                                    <div className="space-y-1.5">
                                        <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">Título</Label>
                                        <Input
                                            value={editForm.titulo}
                                            onChange={(e) => setEditForm(f => ({ ...f, titulo: e.target.value }))}
                                            className="bg-[#F7F7F5] dark:bg-[#0f1829] border-[#A5B4FC] dark:border-[#4a5568] text-[#191918] dark:text-white rounded-xl"
                                        />
                                    </div>
                                    {/* Descrição */}
                                    <div className="space-y-1.5">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="space-y-1.5">
                                            <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">Data Início</Label>
                                            <DatePicker
                                        ...
                                        <div className="space-y-1.5">
                                            <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">Hora Início</Label>
                                            <TimePicker
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="space-y-1.5">
                                            <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">Data Fim</Label>
                                            <DatePicker
                                        ...
                                        <div className="space-y-1.5">
                                            <Label className="text-xs font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">Hora Fim</Label>
                                            <TimePicker
                                    ...
                                    {confirmingDelete ? (
                                        <div className="rounded-xl border border-red-500/40 bg-red-500/10 p-3 space-y-2">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    disabled={isPending}
                                                    className="flex-1 px-3 py-2 rounded-lg bg-[#E0E7FF] dark:bg-[#2d3347] text-[#191918] dark:text-white text-sm font-medium hover:bg-[#C7D2FE] dark:hover:bg-[#3d4a60] transition-colors disabled:opacity-40"
                                                >
                                                    Cancelar
                                                </button>
                                                <button
                                                    ...
                                                    disabled={isPending}
                                                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-red-500 text-[#191918] dark:text-white text-sm font-medium hover:bg-red-600 transition-colors disabled:opacity-40"
                                                >
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                disabled={isPending}
                                                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-brand-500 text-[#191918] dark:text-white font-medium text-sm hover:bg-brand-600 disabled:opacity-40 transition-colors shadow-lg shadow-brand-500/25"
                                            >
                                            ...
                                            {selectedEvent.extendedProps.leadId && (
                                                <button
                                                    ...
                                                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#E0E7FF] dark:bg-[#2d3347] text-[#191918] dark:text-white font-medium text-sm hover:bg-[#C7D2FE] dark:hover:bg-[#3d4a60] transition-colors"
                                                >
                                                    💬 Conversa
                                                </button>
                                            )}
...
function InfoCard({
    ...
    return (
        <div className="bg-[#F7F7F5] dark:bg-[#0f1829]/60 rounded-xl p-3 border border-[#C7D2FE] dark:border-[#3d4a60]/50">
            <div className="flex items-center gap-1.5 mb-1">
                {icon}
                <span className="text-[10px] font-semibold text-[#6366F1] dark:text-[#94a3b8] uppercase tracking-wider">
                    {label}
            ...
            <p className="text-sm font-medium text-[#191918] dark:text-white truncate">{value}</p>
        </div>
    );
}
